...
class _CheckoutDetailsScreenState extends State<CheckoutDetailsScreen> {
            ...
            child: Form(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _SummaryRow(label: 'Total', value: CurrencyFormatter.format(totals.total, settings.currency), emphasized: true),
  ...
  Future<void> _pickSchedule(ExperienceSettings settings) async {
  ...
  String _formatDateTime(DateTime value) => '${value.day.toString().padLeft(2, '0')}/${value.month.toString().padLeft(2, '0')} ${value.hour.toString().padLeft(2, '0')}:${value.minute.toString().padLeft(2, '0')}';
  ...
  Future<void> _submit() async {
    ...
    final info = CustomerInfo(
      ...
      notes: settings.customerNotesEnabled ? _notesController.text.trim() : '',
