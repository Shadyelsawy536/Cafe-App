...
/// One ModifierGroup section — label with a "Required" / "Choose up to N"
/// hint, then a horizontal row of selectable modifier cards. A product can
/// have several of these stacked (e.g. "Milk Type" required + "Extras"
/// optional), each enforcing its own min/max independently.
                  ...
                  child: AnimatedContainer(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          modifier.price == 0 ? 'Free' : '+€${modifier.price.toStringAsFixed(2)}',
                          style: TextStyle(
                            fontSize: 10,
                            color: isSelected
