...
final Expando<_OrderingUiState> _uiState =
    Expando<_OrderingUiState>();

_OrderingUiState _stateFor(
  OrderingController controller,
) =>
    _uiState[controller] ??=
        _OrderingUiState();

extension OrderingControllerUiState
    on OrderingController {
  String? get selectedCategory =>
      _stateFor(this).selectedCategory;
